...
<html lang="en" class="no-js">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
        ...
        <!-- THEME STYLES -->
        <link href="resources/layout.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body id="body" data-spy="scroll" data-target=".header">
        ...
        <!--========== SLIDER ==========-->
        <div class="promo-block parallax-window" data-parallax="scroll" data-image-src="resources/img/1920x1080/3.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="promo-block-divider">
                            <h1 class="promo-block-title">Kalpesh <br/> Pansheriya</h1>
                            <p class="promo-block-text">Database Administrator &amp; Back-end Developer</p>
                        </div>
